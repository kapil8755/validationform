...
if (!$error) {
if(mysqli_query($conn, "INSERT INTO members(name, email, mobile ,password) VALUES('" . $name . "', '" . $email . "', '" . $mobile . "', '" . md5($password) . "')")) {
...
<head>
<meta charset="UTF-8">
<title>Simple Registration Form in PHP And Validation</title>
